...
key_ck_input_bucket_name_ENV = os.environ['key_ck_input_bucket_name_name']
...
def lambda_handler(event, context):
    ...
    ssm_ck_input_bucket_name = ssm_client.get_parameter(Name = key_ck_input_bucket_name_ENV)
    value_ck_input_bucket_name = ssm_ck_input_bucket_name['Parameter']['Value']
    print(f'Transcribe Input Bucket:{value_ck_input_bucket_name}')
    ...
    return {
        ...
        'body': value_ck_input_bucket_name,
