...
key_ck_dynamodb_output_table_name_ENV = os.environ['key_ck_dynamodb_output_table_name']
...
def lambda_handler(event, context):
    ...
    ssm_ck_dynamodb_output_table_name = ssm_client.get_parameter(Name = key_ck_dynamodb_output_table_name_ENV)
    value_dynamodb_output_table_name = ssm_ck_dynamodb_output_table_name['Parameter']['Value']
